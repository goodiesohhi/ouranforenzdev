...
public class Case1 extends StoryManager{ // opens class for first case
	...
	void update() throws IOException{ // runs update loop
		...
		characters.add(new Character("Gilligan Tam",200,220)); // adds Gilligan
		...
		characters.add(new Character("Witness Stand",-50,50));
		...
		characters.add(new Character("Enrico Nocent",150,-105));
		...
		startCExamine(0); // starts first cross-examination
		 ...
		 Main.cExamine[Main.examineSlot].add("Trust me, I'm a professional.", "Enrico Nocent",  new String[] {"A professional?","Yes, a professional.","Ok."} ,  new String[] {"Ouran Forenz","Enrico Nocent","Ouran Forenz"} , 0, null,"enricoWitness",0);
		 ...
		 showAni("Witness Stand","witnessBench",0,false);

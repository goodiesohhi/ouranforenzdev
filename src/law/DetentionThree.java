...
public class DetentionThree extends Location {
	...
	void events(int i) {
		...
		if (i==0) {
			story.insertD("Just a grey wall. Itâ€™s a prison, so itâ€™s what youâ€™d expect.", "Ouran");
		}
	...
	void talk(int i) {
		...
		if (i == 0)
		{
			story.insertD("Iâ€™m the heir of the famous company Saiba Corp.", "Keto");
		...
		if (i == 2)
		{
			story.insertD("Itâ€™s the company that my father built from the ground up.", "Keto");
		...
		if (i == 3)
		{
			story.insertD("Itâ€™s the greatest card in the game!", "Keto");
	...
	protected void present(RecordEntry recordEntry)
	{
		...
		{
			story.insertD("So what are these â€œunethical business practices?â€�", "Ouran");
		...
		{
			story.insertD("Itâ€™s the lynchpin card in my deck.", "Keto");
		...
		{
			story.insertD("I donâ€™t think Iâ€™m aware of anything about that. Sorry...", "Keto");
		}
	}
}
